...
4. **FIRE types** — Traditional (default spending = current × 0.85), Chubby (a higher spending level the
   user enters; no default), Coast (stop contributing now; work until a chosen age, default 65; then
